...
<body onload="myFunc()">
  ...
  <nav class="navbar navbar-inverse">
    ...
    <div class="container">
        <h2 style="text-align:center">An OTP has been sent to the mail registered with the given account.</h2>
        <h2 style="text-align:center">Enter the OTP to reset your password.</h2>
        <br><br><br>
