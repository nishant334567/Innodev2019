...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="adminavailable.php">Available</a></li>
...
<div class="row" style="border: 1px solid black;margin-left:10px;margin-right:10px;">
  <h1 style="text-align: center">All Status</h1>
  <div class="col-md-1" style="text-align: center;font-size:20px;">Id</div>
  <div class="col-md-4" style="text-align: center;font-size:20px;">Worker</div>
<div class="col-md-4"style="text-align: center;font-size:20px;">Status</div>
<div class="col-md-3"style="text-align: center;font-size:20px;">Field</div>
<br><br>
<?php
...
while($row=mysqli_fetch_array($result))
{
    ...
    $field=$row[2];
      ...
      echo "<div class='col-md-4' style='text-align: center;font-size:20px;'>".$wor."</div>";
    echo "<div class='col-md-4'style='text-align: center;font-size:20px;'>".$st."</div>";
    echo "<div class='col-md-3'style='text-align: center;font-size:20px;'>".$field."</div>";
      echo "<br><br><br>";
    }
    ?>
    <br><br><br>
    ...
    <br><br>
    <h2 style="text-align:center">Add an employ</h2>
    <div class="container">
    <form action="adminaddavail.php" method="POST">
      <div class="col-md-4"><input type="text" name="uname" class="form-control" placeholder="username" required></div>
      <div class="col-md-4">
  ...
  <div class="col-md-4"><button type="submit" class="btn btn-primary btn-block">Add employ</button></div>
  </form>
  <br>
  </div>
  <br><br><br>
