...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a href="adminbooking.php">Booking</a></li>
...
<div class="col-md-1" style="text-align: center;font-size:20px;">User</div>
<br><br>
<?php
...
while($row=mysqli_fetch_array($result))
{
    ...
    echo "<div class='col-md-1' style='text-align: center;font-size:20px;'>".$user."</div>"; 
    echo "<br><br><br><br>";
}
?>
<br><br>
