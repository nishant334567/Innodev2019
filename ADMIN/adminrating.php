...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="adminrating.php">Rating</a></li>
...
<div class="row" style="border: 1px solid black;margin-left:10px;margin-right:10px;">
  <h1 style="text-align: center">All rating</h1>
...
<div class="col-md-4"style="text-align: center;font-size:20px;">Rating</div>
<div class="col-md-3"style="text-align: center;font-size:20px;">No of reviews</div>
<br><br>
<?php
...
while($row=mysqli_fetch_array($result))
{
    ...
    echo "<div class='col-md-4'style='text-align: center;font-size:20px;'>".$rat."</div>";
    echo "<div class='col-md-3'style='text-align: center;font-size:20px;'>".$count."</div>";
      echo "<br><br><br>";
    }
    ?>
    <br><br><br>
    ...
    <div class="container">
    <form action="adminaddrat.php" method="POST">
      <div class="col-md-6"><input type="text" name="uname" class="form-control" placeholder="username" required></div>
      <div class="col-md-6">
  </div>
