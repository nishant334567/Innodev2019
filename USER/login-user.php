...
<html>
    ...
    <body style="background-color: rgb(240, 223, 223)" onload="myFunc()">
                <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
                  ...
                  <br>
                      <br>
                      <h1 style="text-align: center">Get your problems solved</h1>
                      <br>
                  <div class="container" style="border: rgb(214, 207, 207) solid 1px;box-shadow: 0px 0px 10px 5px #fc4c81;">
                    <br>
                        <h2>Welcome Back</h2>
                        <p>We promise to provide you the best experience</p>
                        <form action="valid-user.php" method="POST" class="was-validated">
                        ...
                        <a href="resetpass.php?link=user">Reset or forget password</a>
                        <br>
                      </div>
                      <br>
                      <h1 style="text-align: center">Not made an account?</h1>
                      <h1 style="text-align: center">Register Here and forget about household issues.</h1>
        <div style="margin:10px;padding: 25px;border: dimgray dotted 3px;">
            <form action="regis-user.php" method="POST" enctype="multipart/form-data"><h1 style="text-align: center">Create you new account</h1>
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="password" class="form-control" minlength="8" id="inputPassword4" name="pass" placeholder="Password" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="inputAddress">Name</label>
                      <input type="text" class="form-control" id="inputAddress" pattern="[A-Za-z\s]{}" name="name" placeholder="Name" required>
                    </div>
                    <div class="form-group">
