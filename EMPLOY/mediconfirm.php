...
<input type="checkbox" name="heavy" value="heavy"> Homoeopathic
  <input type="checkbox" name="light" value="Medium"> Aloepathic
  <input type="checkbox" name="others" value="Light"> Ayurvedic
  <br>
  <br>
  <div class="form-group green-border-focus">
  <label for="exampleFormControlTextarea5">Describe About the Medicine Needed</label>
